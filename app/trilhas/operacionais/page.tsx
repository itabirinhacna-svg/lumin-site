...
export default function OperacionaisPage() {
  const trilhas = getTracksByArea("operacionais");
  ...
  return (
    <main style={page}>
      <div style={wrap}>
        ...
        <p style={subtitle}>Cargos com biblioteca pronta, base geral e caderno especifico por funcao.</p>
...
const grid = { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px,1fr))", gap: 20, marginTop: 36 } as const;
const card = {
  background: "#fff",
